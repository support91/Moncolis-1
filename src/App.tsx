      ...
      <div className="min-h-screen flex items-center justify-center bg-secondary p-4">
        <div className="w-full max-w-4xl">
          <div className="text-center mb-12">
            <h1 className="text-5xl font-bold text-foreground mb-4">MonColis.express</h1>
            <p className="text-xl text-muted-foreground">Plateforme de livraison pour l'Afrique de l'Ouest</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <button
              onClick={() => setUserSelection('client')}
              className="bg-white rounded-lg shadow-lg border border-border p-8 hover:shadow-xl transition-all hover:-translate-y-1 hover:border-primary"
            >
            ...
            >
              ...
              <h3 className="text-xl font-bold text-foreground mb-2">Partenaire</h3>
              <p className="text-muted-foreground text-sm">
